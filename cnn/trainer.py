...
class  Trainer(object):
    ...
    def __init__(self, data_file='../data/more_data.pkl', 
        ...
        self.n_train_batches /= train_batch_size
        ...
        print '======== dataset'
        print 'train:', self.train_set_x.get_value(borrow=True).shape 
        print 'train number of seizures:', sum(self.train_set_y.get_value(borrow=True))
    ...
    def evaluate_lenet(self, learning_rate=0.01, n_epochs=7,
                    n_timesteps=1000,
                    dim=18,
                    nkerns=[6, 16, 120],
                    recept_width=143,
        ...
        train_model = theano.function([index], [cost, g_W3, g_b3, g_W2, g_b2, g_W1, g_b1, g_W0, g_b0], updates=updates,
            givens={
